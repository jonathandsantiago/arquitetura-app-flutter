...
class Internationalization {
  Internationalization(this.locale);

  final Locale locale;

  static Internationalization of(BuildContext context) =>
      Localizations.of<Internationalization>(context, Internationalization)!;
...
class InternationalizationDelegate
  ...
  const InternationalizationDelegate();

  @override
  bool isSupported(Locale locale) {
    final language = locale.toString();
    return Internationalization.languages().contains(
      language.endsWith('_')
  ...
  Future<Internationalization> load(Locale locale) =>
      SynchronousFuture<Internationalization>(Internationalization(locale));
